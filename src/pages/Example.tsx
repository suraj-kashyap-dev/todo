...
const Example: React.FC = () => {
    ...
    return (
        <div className="max-w-2xl mx-auto p-4">
            <h1 className="text-2xl font-bold mb-6 text-center">UI Component Examples</h1>
            ...
            {renderSection(
                ...
                <>
                    ...
                    <Checkbox label="Subscribe to Newsletter" error="This field is required." />
                    <Checkbox label="Enable Notifications" helperText="You can change this later." />
                </>
            )}
            ...
            {renderSection(
                ...
                <>
                    ...
                    <Radio name="options" label="Option 2" error="Please select an option." />
                </>
            )}
